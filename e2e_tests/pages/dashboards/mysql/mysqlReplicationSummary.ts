...
export default class MysqlReplicationSummary {
  constructor() {}
  ...
  metrics: GrafanaPanel[] = [
    ...
    { name: 'Replication Error No', type: 'stat' },
    ...
    { name: 'Binlog Data Written Hourly', type: 'stat' },
    { name: 'Binlogs Count', type: 'stat' },
    { name: 'Binlogs Created Hourly', type: 'stat' },
    { name: 'Relay Log Space', type: 'stat' },
    { name: 'Relay Log Written Hourly', type: 'stat' },
