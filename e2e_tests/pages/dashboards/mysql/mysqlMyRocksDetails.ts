...
export default class MysqlMyRocksDetails implements DashboardInterface {
  ...
  metrics: GrafanaPanel[] = [
    ...
    { name: 'MyRocks Cache Data Bytes R/W', type: 'unknown' },
    ...
    { name: 'MyRocks Cache Data Bytes Inserted', type: 'unknown' },
    ...
    { name: 'MyRocks Bytes Read by Iterations', type: 'unknown' },
    { name: 'MyRocks Write ops', type: 'timeSeries' },
    { name: 'MyRocks WAL', type: 'timeSeries' },
    { name: 'MyRocks Number Reseeks in Iterations', type: 'unknown' },
