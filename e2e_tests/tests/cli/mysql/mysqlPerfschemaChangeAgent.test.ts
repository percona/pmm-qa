...
pmmTest.describe('Tests to verify pmm-admin inventory change agent functionality', () => {
  ...
  pmmTest(
    'PMM-T2270 - Verify pmm-admin inventory change agent flags username and password @pmm-ps-integration',
  ...
  pmmTest(
    'PMM-T2271 - Verify pmm-admin inventory change agent flag custom labels @pmm-ps-integration',
  ...
  pmmTest(
    'PMM-T2272 - Verify pmm-admin inventory change agent flag log-level, debug, trace and json @pmm-ps-integration',
    async ({ agentsPage, cliHelper, grafanaHelper, page }) => {
      let commands = [
  ...
  pmmTest(
    'PMM-T2274 - Verify pmm-admin inventory change agent flag enable @pmm-ps-integration',
  ...
  pmmTest('PMM-T2278 - Verify pmm-admin inventory change agent flag disable collectors @pmm-ps-integration', async ({ cliHelper }) => {
    await cliHelper
      .execSilent(
  ...
  pmmTest(
    'PMM-T2273 - Verify pmm-admin inventory change agent flags for tls @pmm-ps-integration',
    async ({ cliHelper, grafanaHelper, page, servicesPage }) => {
  ...
  pmmTest('PMM-T2280 - Verify pmm-admin inventory change agent flag listen port @pmm-ps-integration', async ({ cliHelper }) => {
    let commands = [
