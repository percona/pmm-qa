...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | done | B1 | none | | `codeceptjs-e2e/tests/leftNavigation_test.js` | `e2e_tests/tests/leftNavigation.test.ts` | @menu | 98% | 2026-07-07 | PMM-T1830 PASS; nav tests already in navigation.test.ts; PR pending |
