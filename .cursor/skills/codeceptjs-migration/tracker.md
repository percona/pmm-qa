...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | in-progress | B1 | none | | `codeceptjs-e2e/tests/leftNavigation_test.js` | `e2e_tests/tests/leftNavigation.test.ts` | @menu | | | PMM-T1830 log zip download; nav tests in navigation.test.ts |
