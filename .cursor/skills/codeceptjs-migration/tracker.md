...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | pending | B1 | none | | `codeceptjs-e2e/tests/leftNavigation_test.js` | `e2e_tests/tests/leftNavigation.test.ts` | @new-navigation | | | UI nav; reuse `leftNavigation` fixture |
