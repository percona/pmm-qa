...
def main():
    ...
    if args.env in "ami":
        ...
        if args.pre_post == "post":
            ...
            verify_command('sudo victoriametrics --version | grep victoria-metrics-20221201-162618-pmm-6401-v1.82.1')
    else:
        ...
        if args.pre_post == "post":
            ...
            verify_command(
                ...
                f"RUNNING")
            verify_command(
                f"docker exec {pmm_server_docker_container} victoriametrics --version | grep victoria-metrics-20221201-162618-pmm-6401-v1.82.1")
