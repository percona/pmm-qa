...
test.describe('Valeky CLI tests', { tag: '@valkey' }, async () => {
  ...
  test("PMM-T6666 User can use connection timeout while using pmm-admin add valkey", async ({ }) => {
  ...
  test("PMM-T6663 User can use connection timeout while using pmm-admin add valkey", async ({ }) => {
