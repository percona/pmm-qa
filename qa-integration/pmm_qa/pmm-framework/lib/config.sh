...
register_database MYSQL \
  '5.7 8.0 8.4 9.7' \
  'QUERY_SOURCE SETUP_TYPE CLIENT_VERSION TARBALL ENCRYPTED_CLIENT_CONFIG TIME_ZONE' \
  'DEFAULT_VERSION=9.7' \
  'QUERY_SOURCE=perfschema' 'SETUP_TYPE=' 'CLIENT_VERSION=3-dev-latest' \
  'TARBALL=' 'ENCRYPTED_CLIENT_CONFIG=false' 'TIME_ZONE='

register_database PS \
  '5.7 8.0 8.4' \
  'QUERY_SOURCE SETUP_TYPE CLIENT_VERSION TARBALL NODES_COUNT MY_ROCKS ENCRYPTED_CLIENT_CONFIG BACKUP TIME_ZONE' \
  'DEFAULT_VERSION=8.0' \
  'QUERY_SOURCE=perfschema' 'SETUP_TYPE=' 'CLIENT_VERSION=3-dev-latest' \
  'TARBALL=' 'NODES_COUNT=1' 'MY_ROCKS=false' 'ENCRYPTED_CLIENT_CONFIG=false' 'BACKUP=false' 'TIME_ZONE='

register_database SSL_MYSQL \
  '5.7 8.0 8.4' \
  'QUERY_SOURCE SETUP_TYPE CLIENT_VERSION TARBALL' \
  'DEFAULT_VERSION=8.0' \
  'QUERY_SOURCE=perfschema' 'SETUP_TYPE=' 'CLIENT_VERSION=3-dev-latest' 'TARBALL=' 'TIME_ZONE='
