...
register_database PSMDB \
  ...
  'CLIENT_VERSION SETUP_TYPE COMPOSE_PROFILES TARBALL OL_VERSION GSSAPI STORAGE_ENGINE MINIO GENERATE_TRAFFIC WT_CACHE_GB' \
  ...
  'GENERATE_TRAFFIC=yes' 'WT_CACHE_GB='
