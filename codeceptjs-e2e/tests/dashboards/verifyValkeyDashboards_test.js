...
Scenario(
  'PMM-T2087 - Open the Valkey Overview dashboard and verify metrics @valkey-nightly @dashboards',
...
Scenario(
  'PMM-T2087 - Open the Valkey Clients dashboard and verify metrics @valkey-nightly @dashboards',
  async ({ I, dashboardPage }) => {
...
Scenario(
  'PMM-T2087 - Open the Valkey Cluster Details dashboard and verify metrics @valkey-nightly @dashboards',
  async ({ I, dashboardPage }) => {
...
Scenario(
  'PMM-T2087 - Open the Valkey Command Detail dashboard and verify metrics @valkey-nightly @dashboards',
  async ({ I, dashboardPage }) => {
...
Scenario('PMM-T2087 - Open the Valkey Load dashboard and verify metrics @valkey-nightly @dashboards', async ({ I, dashboardPage }) => {
...
Scenario('PMM-T2087 - Open the Valkey Memory dashboard and verify metrics @valkey-nightly @dashboards', async ({ I, dashboardPage }) => {
...
Scenario(
  'PMM-T2087 - Open the Valkey Network dashboard and verify metrics @valkey-nightly @dashboards',
  async ({ I, dashboardPage }) => {
...
Scenario(
  'PMM-T2087 - Open the Valkey Persistence Details dashboard and verify metrics @valkey-nightly @dashboards',
  async ({ I, dashboardPage }) => {
...
Scenario(
  'PMM-T2087 - Open the Valkey Replication dashboard and verify metrics @valkey-nightly @dashboards',
  async ({ I, dashboardPage }) => {
...
Scenario(
  'PMM-T2087 - Open the Valkey Slowlog dashboard and verify metrics @valkey-nightly @dashboards',
  async ({ I, dashboardPage }) => {
