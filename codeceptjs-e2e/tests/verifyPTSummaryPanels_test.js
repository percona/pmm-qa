...
Scenario(
  'PMM-T666 - Verify summary for PGSQL is displayed on Instance Summary dashboard @dashboards @nightly',
  async ({
...
Scenario(
  'PMM-T666 - Verify summary for PDPGSQL is displayed on Instance Summary dashboard @dashboards @nightly',
  async ({
    I, dashboardPage, inventoryAPI, adminPage,
  }) => {
