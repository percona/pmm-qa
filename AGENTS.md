...
| [qa-integration/](qa-integration/) | `pmm-framework` (bash CLI) that provisions PMM Clients and monitored DBs on prebaked images on the `pmm-qa` Docker network | [pmm-framework/README.md](qa-integration/pmm_qa/pmm-framework/README.md) · [pmm_qa/README.md](qa-integration/pmm_qa/README.md) · [lib/config.sh](qa-integration/pmm_qa/pmm-framework/lib/config.sh) |
