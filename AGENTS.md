...
| [.claude/](.claude/) | CodeceptJS-to-Playwright migration skill, its agents and scripts (migration control branch only) | [skills/codeceptjs-migration/](.claude/skills/codeceptjs-migration/SKILL.md) |
