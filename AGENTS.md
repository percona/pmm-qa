...
| [.claude/](.claude/) | Only the `qa-code-review` skill, which this repo's CI review runs. The Claude Code agents (Test Runner, Investigator, FB Reporter, Router), their skills, hooks and settings live in [percona/pmm-ai](https://github.com/percona/pmm-ai) (`plugins/pmm-qa`, `environment/`) | [qa-code-review](.claude/skills/qa-code-review/SKILL.md) · [AUTOMATIONS.md](https://github.com/percona/pmm-ai/blob/main/docs/AUTOMATIONS.md) |
